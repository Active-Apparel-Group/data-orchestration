-- Table: dbo.xCAMILLA_ORDER_LIST_RAW
-- Database: ORDERS
-- Purpose: [Add description of table purpose]
-- Dependencies: [List any dependent tables/views]

CREATE TABLE [dbo].[xCAMILLA_ORDER_LIST_RAW] (
    [AAG ORDER NUMBER] NVARCHAR(100) NULL,
    [INFOR WAREHOUSE CODE] NVARCHAR(100) NULL,
    [INFOR FACILITY CODE] NVARCHAR(100) NULL,
    [INFOR BUSINESS UNIT AREA] NVARCHAR(100) NULL,
    [CUSTOMER NAME] NVARCHAR(100) NULL,
    [INFOR CUSTOMER CODE] NVARCHAR(100) NULL,
    ...
    [INFOR ORDER TYPE] NVARCHAR(100) NULL,
    ...
    [INFOR SEASON CODE] NVARCHAR(100) NULL,
    ...
    [LONGSON ALIAS] NVARCHAR(100) NULL,
    ...
    [3/6 MTHS] NVARCHAR(100) NULL,
    [6/12 MTHS] NVARCHAR(100) NULL,
    [12/18 MTHS] NVARCHAR(100) NULL,
    [18/24 MTHS] NVARCHAR(100) NULL,
    ...
    [AB/S] NVARCHAR(100) NULL,
    [AB/M] NVARCHAR(100) NULL,
    [AB/XL] NVARCHAR(100) NULL,
    [CD/XS] NVARCHAR(100) NULL,
    [CD/S] NVARCHAR(100) NULL,
    [CD/M] NVARCHAR(100) NULL,
    [CD/L] NVARCHAR(100) NULL,
    [CD/XL] NVARCHAR(100) NULL,
    [C/XS] NVARCHAR(100) NULL,
    [C/S] NVARCHAR(100) NULL,
    [C/M] NVARCHAR(100) NULL,
    [C/L] NVARCHAR(100) NULL,
    [C/XL] NVARCHAR(100) NULL,
    [D/XS] NVARCHAR(100) NULL,
    [D/S] NVARCHAR(100) NULL,
    [D/M] NVARCHAR(100) NULL,
    [D/L] NVARCHAR(100) NULL,
    [D/XL] NVARCHAR(100) NULL,
    [D/XXL] NVARCHAR(100) NULL,
    [TOTAL QTY] NVARCHAR(100) NULL,
    [DESTINATION] NVARCHAR(100) NULL,
    [DESTINATION WAREHOUSE] NVARCHAR(100) NULL,
    [ALLOCATION (CHANNEL)] NVARCHAR(100) NULL,
    [INFOR ADDRESS ID] NVARCHAR(100) NULL,
    ...
    [INFOR DELIVERY CODE] NVARCHAR(100) NULL,
