...
CREATE TABLE [dbo].[xTAYLOR_MADE_ORDER_LIST_RAW] (
    ...
    [TARIFF RELIEF DISCOUNT (20%)] NVARCHAR(100) NULL,
    [FOB TO USE ON PRODUCT INVOICE] NVARCHAR(100) NULL,
    ...
    [TARIFF RATE CHARGED TO AAG] NVARCHAR(100) NULL,
    [TARIFF LOSS] NVARCHAR(100) NULL,
