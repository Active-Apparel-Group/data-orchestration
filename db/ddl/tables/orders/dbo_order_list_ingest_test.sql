...
CREATE TABLE [dbo].[ORDER_LIST_INGEST_TEST] (
    ...
    [CUSTOMER PRICE] DECIMAL(4,2) NULL,
    [USA ONLY LSTP 75% EX WORKS] DECIMAL(4,2) NULL,
    [EX WORKS (USD)] DECIMAL(4,2) NULL,
    ...
    [SMS PRICE USD] DECIMAL(4,2) NULL,
    ...
    [FINANCE EST (USD)] TINYINT NULL,
    [Warehouse] NVARCHAR(100) NULL,
    [NASC TO WHITE FOX (USD)] DECIMAL(3,1) NULL,
