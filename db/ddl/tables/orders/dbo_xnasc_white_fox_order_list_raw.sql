-- Table: dbo.xNASC_WHITE_FOX_ORDER_LIST_RAW
-- Database: ORDERS
-- Purpose: [Add description of table purpose]
-- Dependencies: [List any dependent tables/views]

CREATE TABLE [dbo].[xNASC_WHITE_FOX_ORDER_LIST_RAW] (
    ...
    [∆] NVARCHAR(100) NULL,
    [NASC TO ROC PRICE (RMB) (inc VAT)] NVARCHAR(100) NULL,
    [NASC TO WHITE FOX (USD)] NVARCHAR(100) NULL,
