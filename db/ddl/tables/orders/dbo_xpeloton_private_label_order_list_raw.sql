-- Table: dbo.xPELOTON_PRIVATE_LABEL_ORDER_LIST_RAW
-- Database: ORDERS
-- Purpose: [Add description of table purpose]
-- Dependencies: [List any dependent tables/views]

CREATE TABLE [dbo].[xPELOTON_PRIVATE_LABEL_ORDER_LIST_RAW] (
    ...
    [ORIGINAL PO NUMBER] NVARCHAR(100) NULL,
    ...
    [3X] NVARCHAR(100) NULL,
    [4X] NVARCHAR(100) NULL,
