...
CREATE INDEX [IX_ORDER_LIST_V2_action_type] ON [dbo].[ORDER_LIST_V2] ([action_type])
...
CREATE INDEX [IX_ORDER_LIST_V2_sync_timestamps] ON [dbo].[ORDER_LIST_V2] ([sync_attempted_at], [sync_completed_at])
...
CREATE OR ALTER TRIGGER [TR_ORDER_LIST_V2_UpdateTimestamp] 
