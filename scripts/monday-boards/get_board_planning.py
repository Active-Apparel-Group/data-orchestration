...
def truncate_table():
    ...
    try:
        ...
        # Verify truncation
        verify_result = db.run_query("SELECT COUNT(*) as count FROM dbo.MON_COO_Planning", "orders")
...
def concurrent_insert_chunk(chunk_data, columns, table_name='MON_COO_Planning'):
