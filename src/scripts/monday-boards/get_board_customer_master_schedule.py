...
def get_approved_columns():
    ...
    try:
        ...
        with open(mapping_file, 'r', encoding='utf-8') as f:
          ...
          # Get schema decisions for this board
        schema_decisions = mapping_data.get('monday_boards', {}).get(BOARD_KEY, {}).get('schema_decisions', {})
...
def record_schema_decision(column_name, column_type, approved, reason=""):
    ...
    try:
        ...
        if 'schema_decisions' not in mapping_data['monday_boards'][BOARD_KEY]:
            mapping_data['monday_boards'][BOARD_KEY]['schema_decisions'] = {
                'approved_columns': [],
                'rejected_columns': []
            }
          # Record decision
        ...
        if approved:
            ...
            mapping_data['monday_boards'][BOARD_KEY]['schema_decisions']['rejected_columns'].append(decision_entry)
