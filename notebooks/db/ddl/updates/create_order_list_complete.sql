...
CREATE TABLE [dbo].[ORDER_LIST] (
    ...
    [One_Size_Alt] INT NULL,  -- Coverage: 2.2%, CONVERTED from nvarchar (renamed to avoid duplicate)
    -- Other Sizes
    ...
    [CUSTOMER PRICE] DECIMAL(4,2) NULL,  -- Coverage: 100.0%, CHANGED from nvarchar
    [USA ONLY LSTP 75% EX WORKS] DECIMAL(4,2) NULL,  -- Coverage: 97.8%, CHANGED from nvarchar
    [EX WORKS (USD)] DECIMAL(4,2) NULL,  -- Coverage: 97.8%, CHANGED from nvarchar
    [ADMINISTRATION FEE] DECIMAL(2,1) NULL,  -- Coverage: 97.8%, CHANGED from nvarchar
    [DESIGN FEE] NVARCHAR(255) NULL,  -- Coverage: 97.8%
    [FX CHARGE] DECIMAL(3,2) NULL,  -- Coverage: 97.8%, CHANGED from nvarchar
    [HANDLING] DECIMAL(2,1) NULL,  -- Coverage: 97.8%, CHANGED from nvarchar
    [PNP] NVARCHAR(255) NULL,  -- Coverage: 97.8%
    [SURCHARGE FEE] NVARCHAR(255) NULL,  -- Coverage: 97.8%
    [DISCOUNT] NVARCHAR(255) NULL,  -- Coverage: 97.8%
    [FINAL FOB (USD)] DECIMAL(17,15) NULL,  -- Coverage: 100.0%, CHANGED from nvarchar
    [HS CODE] NVARCHAR(255) NULL,  -- Coverage: 97.8%
    [US DUTY RATE] DECIMAL(4,3) NULL,  -- Coverage: 97.8%, CHANGED from nvarchar
    [US DUTY] DECIMAL(3,2) NULL,  -- Coverage: 97.8%, CHANGED from nvarchar
    [FREIGHT] TINYINT NULL,  -- Coverage: 97.8%, CHANGED from nvarchar
    [US TARIFF RATE] DECIMAL(4,3) NULL,  -- Coverage: 97.8%, CHANGED from nvarchar
    [US TARIFF] DECIMAL(3,2) NULL,  -- Coverage: 97.8%, CHANGED from nvarchar
    [DDP US (USD)] DECIMAL(17,15) NULL,  -- Coverage: 97.8%, CHANGED from nvarchar
    ...
    [SMS PRICE USD] DECIMAL(4,2) NULL,  -- Coverage: 97.8%, CHANGED from nvarchar
    ...
    [DELIVERY CODE (MODL)] TINYINT NULL,  -- Coverage: 6.7%, CHANGED from nvarchar
    ...
    [TARIFF RELIEF DISCOUNT (20%)] DECIMAL(17,15) NULL,  -- Coverage: 2.2%, CHANGED from nvarchar
    [US Price 2 Dec] NVARCHAR(100) NULL,  -- Coverage: 2.2%
    [FOB TO USE ON PRODUCT INVOICE] DECIMAL(17,15) NULL,  -- Coverage: 2.2%, CHANGED from nvarchar
    ...
    [ADDITIONAL TARIFF RATE] DECIMAL(17,16) NULL,  -- Coverage: 2.2%, CHANGED from nvarchar
    ...
    [ADDITIONAL TARIFF] DECIMAL(3,2) NULL,  -- Coverage: 2.2%, CHANGED from nvarchar
    [CAN Price 2 Dec] NVARCHAR(100) NULL,  -- Coverage: 2.2%
    [ADDITIONAL TARIFF VALUE] TINYINT NULL,  -- Coverage: 2.2%, CHANGED from nvarchar
    ...
    [NASC TO ROC PRICE (RMB) (inc VAT)] DECIMAL(3,1) NULL,  -- Coverage: 2.2%, CHANGED from nvarchar
    [FINANCE EST (USD)] TINYINT NULL,  -- Coverage: 2.2%, CHANGED from nvarchar
    [Warehouse] NVARCHAR(100) NULL,  -- Coverage: 6.7%
    [NASC TO WHITE FOX (USD)] DECIMAL(3,1) NULL,  -- Coverage: 2.2%, CHANGED from nvarchar
    ...
    [FOB (AUD)] NVARCHAR(100) NULL,  -- Coverage: 2.2%
