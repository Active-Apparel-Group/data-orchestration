-- Auto-generated ORDER_LIST_STAGING schema (matches ORDER_LIST)
CREATE TABLE dbo.ORDER_LIST_STAGING (
    ...
    [30] INT NULL,
    [31] INT NULL,
    [32] DECIMAL(17,6) NULL,
    [33] INT NULL,
    [34] INT NULL,
    [35] INT NULL,
    [36] DECIMAL(17,6) NULL,
    [38] DECIMAL(17,6) NULL,
    [4] INT NULL,
    [40] INT NULL,
    [42] INT NULL,
    [43] INT NULL,
    ...
    [ADMINISTRATION FEE] DECIMAL(2,1) NULL,
    ...
    [NOTES FOR PRICE] NVARCHAR(2000) NULL,
    [∆] NVARCHAR(255) NULL,
    ...
    [RAW_SOURCE_TABLE] NVARCHAR(128) NULL,
    [RAW_SOURCE_FILE] NVARCHAR(256) NULL
)
;